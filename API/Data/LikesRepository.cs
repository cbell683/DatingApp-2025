...
public class LikesRepository(AppDbContext context) : ILikesRepository
{
    ...
    public Task<IReadOnlyList<Member>> GetCurrentMemberLikes(string predicate, string memberId)
    {
    ...
    Task<IReadOnlyCollection<string>> ILikesRepository.GetCurrentMemberLikeIds(string memberId)
    {
        throw new NotImplementedException();
    }
}